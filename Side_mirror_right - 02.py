...
def laser_loc(image):
    ...
    laser_gapX = 230        ### horizontal gap between two lasers  ## This equals 6 inch
    laser_gapy = -30        ### vertical gap between two lasers
    
    laser_init_x = 650      ### horizontal initial position of left laser
    laser_init_y = 550      ### vertical initial position of left laser
...
out_persp_canny = cv2.VideoWriter(file+'_perspective.mp4', -1, fps, (1900,800))
...
########################################################################################################  
        ...
        cv2.imshow('all lines- persp transform',all_line_image)
        ...
        out_persp_canny.write(persp__s)
